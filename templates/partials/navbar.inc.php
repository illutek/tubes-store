        ...
        <li><?php global $user;
          if ($user->uid != 0) {
            ...
            print '<li class="first">
                        <a href="' . url('user') . '">' . '<i class="fa fa-sign-in fa-lg" aria-hidden="true"></i>' . t('Login') . '</a>
                        </li>';
            print '<li>
                        <a href="' . url('user/register') . '">' . '<i class="fa fa-plus fa-lg" aria-hidden="true"></i>' . t('Register') . '</a>
                        </li>';
          } ?>
